...
$date20->month( $date20->month() + 3 );
is($date20->month(), 1, "Add months: new month");
is($date20->year(), 2019, "Add months: new year");

# test date correction sub
my $date21 = Local::Date->new(year => 2017, month => 5, day => 5, hours => 3, minutes => 20, seconds => 50);
$date21->seconds( $date21->seconds() - 165 );
is($date21->seconds(), 05, "Subtract seconds: new seconds");
is($date21->minutes(), 18, "Subtract seconds: new minutes");

$date21->minutes( $date21->minutes() - 98 );
is($date21->minutes(), 40, "Subtract minutes: new minutes");
is($date21->hours(), 1, "Subtract minutes: new hours");

$date21->hours( $date21->hours() - 29 );
is($date21->hours(), 20, "Subtract hours: new hours");
is($date21->day(), 3, "Subtract hours: new day");

$date21->day( $date21->day() - 33 );
is($date21->day(), 31, "Subtract days: new day");
is($date21->month(), 3, "Subtract days: new month");
